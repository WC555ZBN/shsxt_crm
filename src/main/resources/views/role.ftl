...
<div id="tb">
    <div>
        ...
        <a href="javascript:addModule()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">权限分配</a>
    </div>
    <div>
...
<div id="dlg" class="easyui-dialog" style="width:600px;height:240px;padding: 10px 20px"
...
<div id="module" class="easyui-dialog" style="width:600px;height:240px;padding: 10px 20px"
     closed="true">
