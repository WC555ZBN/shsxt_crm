            ...
            <#if permissions?seq_contains("20")>
                <div title="客户管理" data-options="iconCls:'icon-khgl'" style="padding:10px;">
                    ...
                    <#if permissions?seq_contains("2020")>
                        <a href="javascript:openTab('客户流失管理','customer_loss/index','icon-khlsgl')"
                           class="easyui-linkbutton"
            ...
            <#if permissions?seq_contains("60")>
                <div title="系统管理" data-options="iconCls:'icon-item'" style="padding:10px">
                    ...
                    <#if permissions?seq_contains("6030")>
                        <a href="javascript:openTab('菜单管理','module/index/0','icon-sjzdgl')" class="easyui-linkbutton"
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:250px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>确认新密码：</td>
                <td><input type="password" id="newPassword2" name="configPassword" class="easyui-validatebox" required="true" style="width: 200px"/></td>
            </tr>
        </table>
    </form>
</div>
