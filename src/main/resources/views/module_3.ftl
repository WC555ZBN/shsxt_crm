...
<div id="dlg" class="easyui-dialog" style="width:700px;height:400px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>层级：</td>
                <td><input type="text" id="grade" name="grade" value="2"  readonly="readonly"/> </td>
                <td></td>
                <td>权限码：</td>
            ...
            <tr>
                ...
                <td><input id="parentId" class="easyui-combobox" name="parentId"
                           valueField="id"  textField="moduleName" url="${ctx}/module/queryAllModulesByGrade?grade=1" /><font color="red">*</font> </td>
